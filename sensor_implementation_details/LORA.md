This is by *far* the hardest sensor to implement

This code is for reading (from https://github.com/chandrawi/LoRaRF-Python/blob/main/examples/SX127x/driver_tx.py)
```
import os, sys
